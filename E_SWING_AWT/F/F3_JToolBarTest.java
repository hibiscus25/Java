package E_SWING_AWT.F;

import javax.swing.*;
import java.awt.event.*;

public class F3_JToolBarTest extends JFrame{
    private static final long serialVersionUID = 1L;

    public F3_JToolBarTest(){
        ...
        JToolBar tbEducation = new JToolBar();
            ...
            // Блокируем возможность эффекта интерактивности - при наведении мыши кнопка выделяется
