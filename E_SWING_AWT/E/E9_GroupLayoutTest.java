...
public class E9_GroupLayoutTest extends JFrame{

    public E9_GroupLayoutTest(){
        setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);

            JLabel label = new JLabel("Поиск строки :");                            // Список компонентов формы
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new E9_GroupLayoutTest().setVisible(true);
            }
        });
    }
}
