...
public class E7_CardLayoutTest implements ItemListener {
    private static JPanel cards;
    final static String BUTTONPANEL = "Панель с кнопками";
    final static String TEXTPANEL   = "Панель с текстовым полем";

    /**
     * Метод определения интерфейса панели  @param container - панель содержимого
     */
    public void createPanelUI(Container container) {
        // Создание компонента с выпадающим списком
        JComboBox<String> combobox = new JComboBox<String>(new String[] {BUTTONPANEL, TEXTPANEL});
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException,
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                (new E7_CardLayoutTest()).createPanelUI(frame.getContentPane());
